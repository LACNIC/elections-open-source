...
import net.lacnic.siselecciones.admin.web.panel.admin.EditEleccionesJuntasPanel;
import net.lacnic.siselecciones.admin.web.panel.admin.ListEleccionesJuntasPanel;
