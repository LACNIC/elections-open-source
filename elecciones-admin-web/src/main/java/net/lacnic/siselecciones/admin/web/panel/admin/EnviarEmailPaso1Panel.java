...
import net.lacnic.siselecciones.admin.dashboard.admin.DashboardEnviarEmailPaso2;
		...
		try {
			...
			f.add(new Button("siguiente") {
				...
				public void onSubmit() {
					try {
						Contexto.getInstance().getManagerBeanRemote().modificarTemplateEleccion(template);
