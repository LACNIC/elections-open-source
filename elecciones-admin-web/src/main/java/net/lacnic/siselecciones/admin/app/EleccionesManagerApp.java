...
import net.lacnic.siselecciones.admin.dashboard.admin.DashboardEditarComisionado;
...
import net.lacnic.siselecciones.admin.dashboard.admin.DashboardEnviarEmailPaso1;
...
import net.lacnic.siselecciones.admin.dashboard.error.Error410;
import net.lacnic.siselecciones.admin.dashboard.error.Error500;
...
import net.lacnic.siselecciones.admin.dashboard.user.DashboardHomePublico;
import net.lacnic.siselecciones.admin.dashboard.user.DashboardResultado;
...
import net.lacnic.siselecciones.admin.dashboard.user.DashboardVotarEleccionesJuntas;
import net.lacnic.siselecciones.admin.dashboard.user.DashboardYaVoto;
...
public class EleccionesManagerApp extends AuthenticatedWebApplication {
	...
	protected void init() {
		...
		montarPagina("/votar", DashboardVotar.class);
		montarPagina("/s/votar", DashboardVotarEleccionSimple.class);
		montarPagina("/j/votar", DashboardVotarEleccionesJuntas.class);
