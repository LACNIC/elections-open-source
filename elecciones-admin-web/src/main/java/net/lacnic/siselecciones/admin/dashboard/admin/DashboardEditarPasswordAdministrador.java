			...
			public void onSubmit() {
				...
				if (getPassword().equals(getPassword2())) {
					if (!(UtilsString.wantHashMd5(getPassword()).equalsIgnoreCase(pass))) {
						Contexto.getInstance().getManagerBeanRemote().editarPassAdmin(admin.getUserAdminId(), UtilsString.wantHashMd5(getPassword()), SecurityUtils.getAdminId(), SecurityUtils.getIPClient());
