...
import net.lacnic.siselecciones.admin.web.panel.candidatos.ListCandidatosEleccionPanel;
import net.lacnic.siselecciones.admin.web.panel.usuariopadron.ListUsuariosPadronEleccionPanel;
...
public class DetalleEleccionPanel extends Panel {
	...
	public DetalleEleccionPanel(String id, final long idEleccion, final boolean sent) {
		...
		try {
			...
			add(new Label("linkResultado", Contexto.getInstance().getManagerBeanRemote().obtenerLinkresultado(eleccion)));
