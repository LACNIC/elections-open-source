...
update public.personalizacion set titulo_sitio = 'Sistema de Elecciones - la organización', titulo_login = 'Elecciones de la organización', show_home = false where id_personalizacion = 1;
