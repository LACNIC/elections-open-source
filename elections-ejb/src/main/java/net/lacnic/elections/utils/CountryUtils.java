...
public class CountryUtils {
	...
	public CountryUtils() {
		...
		String[] countriesArray = countriesChar.split(";");

		for (String country : countriesArray) {
			String[] countrySplit = country.split(":");
			this.namesList.add(countrySplit[1]);
			this.idsList.add(countrySplit[0]);
		}
	}
