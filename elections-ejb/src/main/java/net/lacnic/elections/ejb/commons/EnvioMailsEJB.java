...
public interface EnvioMailsEJB {
	...
	void encolarEnvioMasivo(List usuarios, ElectionEmailTemplate templateEleccion);

	List<Email> obtenerEmailsParaEnviar();

	void reagendar(List<Email> emailsProblematicos);

	void encolarEnvioIndividual(ElectionEmailTemplate templateEleccion, UserVoter us, Auditor au, Election e, List<Vote> votos);
