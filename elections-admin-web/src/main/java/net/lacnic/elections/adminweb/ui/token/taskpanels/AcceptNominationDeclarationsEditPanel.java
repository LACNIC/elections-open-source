...
public class AcceptNominationDeclarationsEditPanel extends AbstractAcceptNominationTaskPanel {

	private static final long serialVersionUID = 1L;

	public AcceptNominationDeclarationsEditPanel(String id, AcceptNominationTaskResolution resolution) {
		super(id, resolution);
