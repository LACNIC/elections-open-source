...
public class AcceptNominationOtherNonStatutoryQuestionsEditPanel extends AbstractAcceptNominationTaskPanel {

	private static final long serialVersionUID = 1L;

	public AcceptNominationOtherNonStatutoryQuestionsEditPanel(String id, AcceptNominationTaskResolution resolution) {
		super(id, resolution);
