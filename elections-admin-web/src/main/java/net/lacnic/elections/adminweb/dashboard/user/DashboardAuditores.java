...
import net.lacnic.elections.adminweb.web.panel.elecciones.AprobacionAuditorPanel;
import net.lacnic.elections.adminweb.web.panel.elecciones.CodigosCandidatoPanel;
import net.lacnic.elections.adminweb.web.panel.elecciones.MoreInformationForAuditPanel;
import net.lacnic.elections.adminweb.web.panel.elecciones.ResultadoEleccionPanel;
import net.lacnic.elections.adminweb.web.panel.elecciones.RevisionAuditorPanel;
