...
public class AcceptNominationNonStatutoryDeclarationsViewPanel extends AbstractAcceptNominationTaskPanel {

	private static final long serialVersionUID = 1L;

	public AcceptNominationNonStatutoryDeclarationsViewPanel(String id, AcceptNominationTaskResolution resolution) {
		super(id, resolution);
